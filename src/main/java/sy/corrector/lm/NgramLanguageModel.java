...
import sy.corrector.lm.collections.Counter;
...
public interface NgramLanguageModel<W>
{
	 ...
	 * {@link ContextEncodedNgramLanguageModel#getLogProb(long, int, int, sy.corrector.lm.ContextEncodedNgramLanguageModel.LmContextInfo)}
	 * .
	 */
