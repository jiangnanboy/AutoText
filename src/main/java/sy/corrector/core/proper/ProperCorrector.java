...
import sy.corrector.core.spelling.SpellingUtils;
import sy.corrector.core.ngram.NgramUtil;
import utils.correct.Segment;
import utils.correct.Util;
...
public class ProperCorrector {
    ...
    public ProperCorrector(String properNamePath, String strokePath) {
        try {
            LoadDict.init(properNamePath, strokePath);
