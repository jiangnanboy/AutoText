 ...
 */
public class PartiallyBorderedRecog {
...
//        opencv_imgproc.adaptiveThreshold(mat, binaryMat, 255, opencv_imgproc.ADAPTIVE_THRESH_GAUSSIAN_C, opencv_imgproc.THRESH_BINARY, 5, 5);
        ...
        // inverting the image
        Mat binaryMatInv = opencv_core.subtract(new Scalar(255), binaryMat).asMat();
        ...
        opencv_imgproc.erode(binaryMatInv, erodeVerticalMat, verKernel, new Point(-1, -1), 3, opencv_core.BORDER_CONSTANT, null);
...
//        imshow("verticallines", verticalLines);
        ...
        opencv_imgproc.erode(binaryMatInv, erodeHorizontalMat, horKernel, new Point(-1, -1), 3, opencv_core.BORDER_CONSTANT, null);
...
//        imshow("vh", vhMat);
        // dilate
        opencv_imgproc.erode(vhMat, vhMat, kernel, new Point(-1, -1), 5, opencv_core.BORDER_CONSTANT, null);
        ...
        verKernel = opencv_imgproc.getStructuringElement(opencv_imgproc.MORPH_RECT, new Size(9, imgHeight*2));
        opencv_imgproc.erode(imgMedian, erodeVerticalMat, verKernel, new Point(-1, -1), 1, opencv_core.BORDER_CONSTANT, null);

        horKernel = opencv_imgproc.getStructuringElement(opencv_imgproc.MORPH_RECT, new Size(imgWidth*2, 1));
